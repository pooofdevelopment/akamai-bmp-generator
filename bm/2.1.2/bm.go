...
func (bm *BotManager) GenerateSensorData() (string, error) {
	...
	tact, _, _ = bm.GenerateTouchEvents()
	...
	sensorData = append(sensorData, sdk.Pair{Id: "-105", Value: ""})
	sensorData = append(sensorData, sdk.Pair{Id: "-108", Value: ""}) // text change events
	sensorData = append(sensorData, sdk.Pair{Id: "-110", Value: ""}) // Motion events
	sensorData = append(sensorData, sdk.Pair{Id: "-117", Value: tact})
	sensorData = append(sensorData, sdk.Pair{Id: "-112", Value: ""}) //double check
	sensorData = append(sensorData, sdk.Pair{Id: "-115", Value: ""}) //double check
