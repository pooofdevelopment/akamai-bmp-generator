...
func (bm *BotManager) GenerateSensorData() (string, error) {
	...
	sensorData = append(sensorData, sdk.Pair{Id: "-104", Value: ""}) // -2,3,-50,-301,null
	...
	sensorData = append(sensorData, sdk.Pair{Id: "-161", Value: motionTimeDataValue}) // 3,802;3,802;21,400
